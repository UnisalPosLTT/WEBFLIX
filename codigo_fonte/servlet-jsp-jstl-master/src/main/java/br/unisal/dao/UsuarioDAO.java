...
public class UsuarioDAO extends GenericDAO implements DAOInterface<Usuario> {
	...
	public Usuario pesquisaUsuarioLogin(String login, String senha) throws ClassNotFoundException, SQLException, IOException 
	{
		String sql = "select id, nome, email, login, senha, uuid from Usuario where login = ? and senha = ?";
